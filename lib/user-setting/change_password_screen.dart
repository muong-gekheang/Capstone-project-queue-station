...
import 'package:queue_station_app/user-setting/forget_password_screen.dart';
...
class _EditAccountState extends State<ChangePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Change Password", style: TextStyle(fontWeight: FontWeight.bold),), backgroundColor: Colors.white,),
      body: Padding(
