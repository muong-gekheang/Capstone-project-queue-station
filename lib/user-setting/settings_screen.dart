...
import 'package:queue_station_app/user-setting/change_password_screen.dart';
import 'package:queue_station_app/user-setting/contact_us_screen.dart';
import 'package:queue_station_app/user-setting/edit_account_screen.dart';
import 'package:queue_station_app/user-setting/setting_card.dart';
import 'package:queue_station_app/user-setting/terms_of_service_screen.dart';
...
class SettingsScreen extends StatelessWidget {
  User user = User(name: "Monica", email: "monica@gmail.com", phone: "0987654321");
            ...
            children: [
              ...
              SettingCard(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    title: const Text("Terms of Services", style: TextStyle(fontWeight: FontWeight.w600),),
                    trailing: const Icon(Icons.arrow_forward_ios, size: 16),
                    onTap: () {
                      Navigator.push(
                        context,
              ...
              SettingCard(
                ...
                children: [
                  ...
                  ListTile(
                    leading: const Icon(Icons.delete_outline, color: Color(0xFFB22222),),
                    title: Text(
                      "Delete Account",
                      style: TextStyle(color: Color(0xFFB22222), fontWeight: FontWeight.w600),
                    ),
                    trailing: const Icon(Icons.arrow_forward_ios, size: 16),
