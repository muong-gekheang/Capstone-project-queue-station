...
class _MenuFormState extends State<MenuForm> {
  ...
  String? _preparationTimeValidator(String? value) {
    ...
    if (minutes == null) return 'Please enter a valid number';
    if (minutes < 0 || minutes > 60) return 'Minutes must be between 0 and 60';
    return null;
  }
  @override
  void initState() {
    ...
    if (menu != null) {
      selectedCategory = mockMenuCategories.firstWhere(
        ...
        orElse: () => mockMenuCategories.isNotEmpty
            ...
            : MenuItemCategory(id: _uuid.v4(), name: 'Unknown'),
      );
    } else {
