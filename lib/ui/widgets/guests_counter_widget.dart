...
class GuestsCounterWidget extends StatelessWidget {
  ...
  final int maxPeople;
  const GuestsCounterWidget({
    super.key,
    required this.numPeople,
    required this.incrPeople,
    required this.decrPeople,
          ...
          child: Stack(
            ...
            children: [
              ...
              const Positioned.fill(
                child: VerticalDivider(color: Color(0xFF73706E), thickness: 1),
              ),
            ],
          ),
        ),
        IconButton(
          onPressed: numPeople < maxPeople ? incrPeople : null,
          color: Colors.white,
          disabledColor: Colors.white,
          style: IconButton.styleFrom(
            backgroundColor: Color(0xFFFF6835),
