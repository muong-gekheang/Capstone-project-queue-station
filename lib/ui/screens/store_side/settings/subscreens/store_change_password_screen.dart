...
class StoreChangePasswordScreen extends StatefulWidget {
  const StoreChangePasswordScreen({super.key});

  @override
  State<StoreChangePasswordScreen> createState() => _EditAccountState();
}

class _EditAccountState extends State<StoreChangePasswordScreen> {
