...
class _EditMenuScreenState extends State<EditMenuScreen> {
  ...
  void initState() {
    ...
    _descriptionController = TextEditingController(
      text: widget.existingMenu.description,
    );
    _priceController = TextEditingController(
      text: widget.existingMenu.price.toString(),
    );
    _minTimeController = TextEditingController(
      text: widget.existingMenu.minPreparationTime.toString(),
    );
    _maxTimeController = TextEditingController(
      text: widget.existingMenu.maxPreparationTime.toString(),
    );
