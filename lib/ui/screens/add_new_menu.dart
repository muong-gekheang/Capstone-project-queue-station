...
class _AddNewMenuState extends State<AddNewMenu> {
  ...
  MenuCategory selectedCategory = mockMenuCategories[0];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        padding: const EdgeInsetsGeometry.symmetric(horizontal: 15, vertical: 25),
        child: Column(
          children: [
            Form(
              key: _formKey,
                ...
                children: [
                  ...
                  DropdownButtonFormField<MenuCategory>(
                    items: mockMenuCategories.map((category){
                      return DropdownMenuItem(child: Text(category.categoryName), value: category,);
                    }).toList(), 
                    onChanged: (value){
                      setState(() {
