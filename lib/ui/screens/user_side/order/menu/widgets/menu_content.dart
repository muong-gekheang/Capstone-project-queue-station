...
class MenuContent extends StatefulWidget {
  ...
  @override
  State<MenuContent> createState() => _MenuScreenState();
}

class _MenuScreenState extends State<MenuContent> {
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: Builder(
                builder: (context) {
                  final filtered = menuVM.filteredMenuItems(
                    query: searchQuery,
      ...
      floatingActionButton: Stack(
        ...
        children: [
          ...
          Positioned(
            right: -2,
            top: -2,
            child: menuVM.totalCartItemsCount == 0
