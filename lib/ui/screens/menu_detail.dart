              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      ButtonWidget(leadingIcon: Icons.delete, title: 'Delete', onPressed: () => onDelete(context), backgroundColor: Color.fromRGBO(230, 57, 70, 1), textColor: Colors.white, padding:  EdgeInsets.symmetric(horizontal: 40, vertical: 5)),
                  
                      ButtonWidget(leadingIcon: Icons.create_outlined, title: 'Edit', onPressed: onEdit, backgroundColor:  Color.fromRGBO(13, 71, 161,1), textColor: Colors.white, padding:  EdgeInsets.symmetric(horizontal: 40, vertical: 5)),
                    ],
                  ),
                )
              ],
