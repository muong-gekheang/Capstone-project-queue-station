...
import 'package:queue_station_app/food-ordering/models/menu_item.dart';
...
class MenuItemScreen extends StatefulWidget {
  ...
  const MenuItemScreen({
    ...
    this.item,
    this.cartItem,
  }) : assert(item != null || cartItem != null,
...
class _MenuItemScreenState extends State<MenuItemScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text(widget.menuItem.name, style: TextStyle(fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
      body: Stack(
        children: [
              ...
              children: [
                              ...
                              children: [
                                CheckboxListTile(
                                  title: Row(
                                    children: [
                                      Expanded(
                                        child: Text(addOn.name, style: TextStyle(fontSize: 16)),
                                      ),
                                      Text(
                                  ...
                                  secondary: addOn.image != null
                                      ? CircleAvatar(
                                          backgroundImage: AssetImage(addOn.image!),
                                          radius: 20,
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Add special instructions for the kitchen or staff',
                    ...
                    child: ElevatedButton(
                      onPressed: (){
                        ...
                        CartItem newItem = CartItem(
                            ...
                            selectedSize: _selectedSize ?? widget.menuItem.defaultSize,
